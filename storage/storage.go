...
type StockRepoI interface {
	...
	StockTransfer(ctx context.Context, req *models.StockTransfer) (int64, error)
	GetListStaffSold(ctx context.Context, req *models.GetListStaffSoldRequest) (resp *models.GetListStaffSoldResponse, err error)
