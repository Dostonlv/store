...
type StockTransfer struct {
	StoreIdFrom int `json:"store_id_from"`
	StoreIdTo   int `json:"store_id_to"`
	ProductId   int `json:"product_id"`
	Quantity    int `json:"quantity"`
}

type GetListStaffSoldRequest struct {
	Date string `json:"date"`
}

type GetListStaffSoldResponse struct {
	Staffs []*GetStaffSoldResponse `json:"staffs"`
}

type GetStaffSoldResponse struct {
